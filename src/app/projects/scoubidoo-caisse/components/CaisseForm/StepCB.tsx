...
function CBRow({ label, cbField, cbValue, pourField, pourValue, onChange, prefill }: {
  label: string
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center gap-1">
        ...
        {prefill && <span className="text-[10px] text-emerald-500 bg-emerald-950/40 px-1.5 py-0.5 rounded">pré-rempli</span>}
      </div>
    ...
    <div className="space-y-5">
      ...
      <section className="space-y-4">
        ...
        <CBRow
          ...
          onChange={setNum}
          prefill={form.sp_cb_jplus1_veille_pourboire_incl != null}
        />
        <CBRow
